...
<form action="{{ route("user.catalogue.updatePermission") }}" class="box">
    @csrf
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach ($permissions as $permission)
                            <tr>
                                <td>
                                    <a class="uk-flex uk-flex-middle uk-flex-space-between">
                                        {{ $permission->name }}
                                ...
                                @foreach ($userCatalogues as $userCatalogue)
                                    <td>
                                        <input 
                                        {{ (collect($userCatalogue->permission) -> contains('id', $permission->id)) ? 'checked' : '' }}
                                        type="checkbox" 
